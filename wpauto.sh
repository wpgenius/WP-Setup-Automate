...
wp core install --admin_user=makarand --admin_email=mane.makarand@gmail.com --url=https://tyche.work/$foldername/ --admin_password= --skip-email=n --prompt

#Install astra theme then create & switch to child theme
wp theme install astra
wp scaffold child-theme --author=TeamWPGenius --author_uri=https://wpgenius.in --theme_name=astra --theme_uri=https://$foldername/ --activate=y --enable-network=y --force=y --prompt
